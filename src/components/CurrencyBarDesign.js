...
<Box color="#636363"className={classes.textMargin}>
Make the bar seamlessly suit your store.
</Box>
...
<FormControlLabel
        control={
          <Checkbox
            checked={state.showCurrencyOnly}
            onChange={handleChange}
            name="showCurrencyOnly"
            color="primary"
          />
        }
        label="Show currency only"
      />
</Box>
<Box  textAlign="start" borderRadius={16} m={2} {...checkboxDefaultProps}>
<FormControlLabel
...
export default CurrencyBarDesign
